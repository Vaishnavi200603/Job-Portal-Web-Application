        ...
        <div class="container-fluid">
            ...
            <section class="job-listings">
                <h2>Companies Details</h2> 
                    ...
                    <jsp:scriptlet>
                        Connection con = null;
                        String C_id="", c_name="", c_email="", c_password="", c_phoneno="";
                        try{
                            ...
                            while(rs.next()){
                                ...
                                <ul> 
                                    <li> 
                                        <h3><center><jsp:expression> c_name </jsp:expression></center></h3> 
                                        <div>
                                            <center><img src="Images/company.jpg" height="100" alt="alt"/></center>
                                        </div>
                                        <br>
                                        <p><span class="fa fa-building"></span> &nbsp;&nbsp;<jsp:expression> c_email </jsp:expression></p> 
                                        <p><span class="fa fa-envelope"></span> &nbsp;&nbsp;<jsp:expression> c_password </jsp:expression></p> 
                                        <p><span class="fa fa-phone"></span> &nbsp;&nbsp;<jsp:expression> c_phoneno </jsp:expression></p> 
                                    </li> 
                                </ul> 
                    <jsp:scriptlet>
                            }
                ...
                <h2>All Job Listings</h2> 
                    ...
                    <jsp:scriptlet>
                        ...
                        try{
                            ...
                            PreparedStatement ps1 = con1.prepareStatement("select * from jobs");
                            ...
                            while(rs1.next()){
                                ...
                                time_venue = rs1.getString("time_venue");
